...
void threadFunc(Scene &scene, ViewPlane &viewPlane, Image &image, int sizeX, int sizeY, int numOfSamples, double start, double end) {
...
int main(int argc, char **argv) {
    ...
    double blocksX=viewPlaneResolutionX/numberOfThreads;
	...
	double start=i*blocksX;
	double end=(i+1)*blocksX;
